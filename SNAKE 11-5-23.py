...
# Initialized game window pygame.display.set_caption
...
fps_contronller = pygame.time.Clock()
# one snake
square_size = 30
...
def show_score(choice, color, font, size):
    ...
    score_surface = score_font.render("APPLE SCORE ;)"+str(score),True, color)
